...
class Home extends PureComponent {
  ...
  // componentDidMount() {
  //   const {
  //     actions: { fetchEarningGraphDataIfNeeded, fetchTeamMatesDataIfNeeded }
  //   } = this.props;
      ...
      <AnimatedView>
        ...
        <div className="row">
          <div className="col-md-6">
            {/* <div>
              <ReactHighcharts config={Home.getConfig(this.props.navs)} />
            </div> */}
            <EarningGraph />
            <br />
            <br />
        ...
        <div className="row">
          ...
          <div className="col-md-4">{/* <TwitterFeed /> */}</div>
        </div>
